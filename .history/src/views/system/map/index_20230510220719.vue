      ...
      try {
        ...
        res.data.forEach((id,index) => {
            ...
            postmanRawData.push({
                ...
                lnglat: index + 1 != res.data.length ? [parseFloat(res.data[index+1].DealLongitude).toFixed(6),parseFloat(res.data[index+1].DealLatitude).toFixed(6)]:[],
                address : '',
