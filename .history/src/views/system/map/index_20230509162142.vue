<template>
    <div class="home_div">
        ...
        <div style="position: relative; width: 400px; height: 400px; background-color: #ccc;">
            <button style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);" @click="setMark">添加地点</button>
        </div>
        <div id="container">
        </div>
    </div>
