      ...
      try {
        ...
        res.data.forEach((id,index) => {
            ...
            postmanRawData.push({
                ...
                lnglat: [parseFloat(id.DealLongitude),parseFloat(id.DealLatitude)],
                netLnglat: index + 1 != res.data.length ? [parseFloat(res.data[index+1].DealLongitude),parseFloat(res.data[index+1].DealLatitude)]:[],
                address : '',
