<template>
    <div class="home_div">
        ...
        <div class="card-container">
            ...
            <el-card style="padding: 0px;" class="card-content" ref="content" :style="{'height': containerHeight}" v-if="content">
...
created() {},
computed: {
    // 计算容器高度，如果内容为空，返回 0，否则返回内容的高度
    containerHeight() {
        return this.content ? `${this.contentHeight}px` : '0'
    },
},
mounted() {
    this.initAMap();
