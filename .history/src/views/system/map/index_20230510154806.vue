<template>
    <div class="home_div">
        ...
        <div class="card-container">
            ...
            <el-card style="padding: 0px;" class="card-content" :style="{'height': containerHeight}">
...
mounted() {
    ...
    this.getPostmanID();
    // 获取内容高度
    console.log(this.$refs.card-content);
    this.contentHeight = this.$refs.card-content.clientHeight
    // 设置容器高度为内容高度
    this.containerHeight = `${this.contentHeight}px`
},
watch: {
