    ...
    <div class="home_div">
        <div class="map_title">
            ...
            <div style="display: flex; justify-content: flex-end; align-items: center;">
                <el-button type="primary" @click="goBackPredictPage" style="margin-right: 10px;">地图</el-button>
            </div>
        </div>
        <el-button style="position: absolute; top: 20%; left: 5%; transform: translate(-50%, -50%);z-index: 10;" @click="setMark">加载地点</el-button>
